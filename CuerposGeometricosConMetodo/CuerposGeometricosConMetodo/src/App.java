...
public class App
{
        ...
        for(int i = 0; i < 3; i++)
        {
            ...
            int op = xd.nextInt();
                switch (op)
                {
                    ...
                    break;
                    case 6:
                    ProblemaZonaEsferica();
                    break;
                    case 7:
                    ProblemaTroncoDeCono();
                    break;
                    case 8:
                    ProblemaTroncoDePiramide();
                    break;
                    case 9:
                    ProblemaOrtoedro();
                    break;
                    ...
                    break;
                    case 15:
                    ProblemaHusoEsfericoYCuñaEsferica();
                    break;
                    case 16:
                    ProblemaCasqueteEsferico();
                    break;
                    case 17:
                    CerraPrograma(); 
                } // SWITCH
    ...
    public static void ProblemaPrisma()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaCilindro()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaPiramide()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaCono()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaEsfera()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaZonaEsferica()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaTroncoDeCono()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaTroncoDePiramide()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaOrtoedro()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaTetraedro()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaHexaedro()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaOctaedro()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaDodecaedro()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaIcosaedro()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaHusoEsfericoYCuñaEsferica()
    {
        Scanner xd = new Scanner(System.in);
    ...
    public static void ProblemaCasqueteEsferico()
    {
        Scanner xd = new Scanner(System.in);
